...
当前 Developer Preview 发布基线已完成一次全量复验：质量门 7/7 全部通过，544
个测试通过，覆盖率 81.16%；claims 26 条全部可追溯。资源警告仅有既有
SQLite 测试夹具的 ResourceWarning，不影响通过，但应在 Alpha 前清理；wheel 与 sdist 的 companion metadata
