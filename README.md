...
2. **Picks a runner.** When the time comes, it looks at the user-approved
   list of installed agent tools (Codex, Claude Code, DSH, anything that
...
examples/                 real-run archives (do not edit — they're audit evidence)
  dsh-minimax-run/        first end-to-end with DeepSeek Harness + MiniMax-M2.7
  dsh-minimax-run-v2/     same task with ephemeral context + verifier enabled
